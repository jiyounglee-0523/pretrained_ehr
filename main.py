...
def main():
    ...
    parser.add_argument('--bert_model', choices=['bert', 'bio_clinical_bert', 'bio_bert', 'pubmed_bert', 'blue_bert'], type=str)
    ...
    parser.add_argument('--output_path', type=str, default='/home/jylee/data/pretrained_ehr/output/KDD_output/')
