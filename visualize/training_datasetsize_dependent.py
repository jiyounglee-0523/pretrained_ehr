...
def visualize_trainingdatasize(result_file:pd.DataFrame, source_file, item, concat:bool):
    ...
    for task in task_list:
        ...
        # bert-induced
        # mean
        ax.plot(x_axis, bert_mean_value, color='darkblue', label='bert_induced')
        # std
        # ax.plot(x_axis, bert_std_value + bert_mean_value, color='lavender')
        # ax.plot(x_axis, mean_value - std_value, color='lavender')
        plt.fill_between(x_axis, bert_mean_value + bert_std_value, bert_mean_value - bert_std_value, facecolor='lavender')

        # singleRNN
        ax.plot(x_axis, single_mean_value, color='crimson', label='singleRNN')
        plt.fill_between(x_axis, single_mean_value + single_std_value, single_mean_value - single_std_value, facecolor='pink')
