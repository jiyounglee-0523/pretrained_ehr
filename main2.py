...
def main():
    ...
    if args.bert_induced:
        from dataset.prebert_dict_dataloader2 import bertinduced_dict_get_dataloader as get_dataloader
        from trainer.bert_dict_trainer2 import bert_dict_Trainer as Trainer
        print('bert induced')
    else:
        from dataset.singlernn_dataloader2 import singlernn_get_dataloader as get_dataloader
        from trainer.base_trainer2 import Trainer
        print('single_rnn')
